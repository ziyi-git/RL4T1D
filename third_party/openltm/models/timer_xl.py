...
# 原：from layers.Transformer_EncDec import TimerBlock, TimerLayer
# 改：
from ..layers.Transformer_EncDec import TimerBlock, TimerLayer
# 原：from layers.SelfAttention_Family import AttentionLayer, TimeAttention
from ..layers.SelfAttention_Family import AttentionLayer, TimeAttention
...
class Model(nn.Module):
    ...
    def forecast(self, x, x_mark, y_mark):
        print("[5] - [G2P2C] Using open-ltm Timer-XL (Tap-out) as GlucoseModel backend.")
        if self.use_norm:
    ...
    def forward(self, x, x_mark, y_mark):
        print("[4] - [G2P2C] Using open-ltm Timer-XL (Tap-out) as GlucoseModel backend.")
